        ...
        <li class="slide side-nav">
          <v-collapse accordion>
            ...
            <v-collapse-item active-url="/admin/users">
              ...
              >
                <span>
                  <font-awesome-icon icon="fa-solid fa-angles-left" />所有用户</span>
              </router-link>
              ...
              <router-link
                ...
                class="side-menu__item sub_menu_item side-menu__label"
              >
                <span><font-awesome-icon icon="fa-solid fa-angles-left" />个人信息</span>
              </router-link>
              ...
              <router-link
                ...
                class="side-menu__item sub_menu_item side-menu__label"
              >
                <span><font-awesome-icon icon="fa-solid fa-angles-left" />从业者验证</span>
              </router-link>
              ...
              <router-link
                ...
                class="side-menu__item sub_menu_item side-menu__label"
              >
                <span><font-awesome-icon icon="fa-solid fa-angles-left" />健康状况</span>
              </router-link>
            </v-collapse-item>
            ...
            <v-collapse-item active-url="/admin/settings">
              ...
              >
                <span style="left: 20px"
                  ><font-awesome-icon icon="fa-solid fa-angles-left" />新增用户</span
                >
              </router-link>
              ...
              >
                <span style="left: 20px"
                  ><font-awesome-icon icon="fa-solid fa-angles-left" />新增管理员</span
                >
              </router-link>
              ...
              >
                <span style="left: 15px"
                  ><font-awesome-icon icon="fa-solid fa-angles-left" />区域管理</span
                >
              </router-link>
