                    ...
                    <div class="user-gender-role-edit">
                      ...
                      >
                        <b-form-select
                          ...
                          data-vv-as="角色"
                          :options="main_user_role == 'regional_admin' ? regional_roles : main_user_role == 'company_admin' ? company_roles: super_roles"
                    ...
                    >
                      <b-form-group id="company-input-group" label="公司">
                        <b-form-select
                          ...
                          :disabled="
                            // (current_user_role == 'practitioner') || (current_user_role != 'admin' && current_user_id_sub == user_id_sub) ? true : false
                            current_user_role == 'admin' ? false : true
                          "
                        ></b-form-select>
...
export default {
  ...
  created() {
    this.main_user_role = Ls.get("Role");
